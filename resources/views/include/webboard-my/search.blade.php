<div class="row mt-3 d-flex align-items-center">
    <div class="col-12 col-lg-11">
        <form class="input-group" action="{{ route('webboard_my') }}">
            ...
            <input type="text" class="form-control" placeholder="ค้นหากระทู้ของคุณ" aria-label="Username"
                aria-describedby="basic-addon1" name="mypost_search" value="{{ $value_search }}">
        </form>
    </div>
...
<div class="row mt-2">
    <div class="col-6">
        <span class="text-20-bolder">กระทู้ของฉัน</span>
    </div>
    <div class="col-6 text-end">
        <span class="text-20-bolder">{{ $myposts->count() }} กระทู้จากทั้งหมด {{ $myposts->total() }}</span>
    </div>
</div>
