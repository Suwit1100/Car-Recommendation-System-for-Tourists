        ...
        <div class="qt-freetime">
            <div class="row">
                <div class="col-12 mt-5">
                    <h5 class="text-center answertitle">กิจกรรมที่คุณมักจะทำเวลาว่าง 7/18</h5>
                </div>
            </div>
            ...
            <div class="row mt-1 d-flex justify-content-center">
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="freetime_health">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://s359.kapook.com/rq/580/435/50/entry/ab52599d-586e-4aca-a72a-d4be592b46fb.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="freetime_relax">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://ik.imagekit.io/tvlk/blog/2021/03/%E0%B9%80%E0%B8%97%E0%B8%84%E0%B8%99%E0%B8%B4%E0%B8%81_Staycations01.jpg?tr=dpr-2,w-675">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="freetime_enjoy">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://www.lgblogger.com/wp-content/uploads/2022/01/24gn600_2.png">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="freetime_survey">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://promotions.co.th/wp-content/uploads/2023/02/hiking.jpg">
                        </div>
                        <div class="box-text">
