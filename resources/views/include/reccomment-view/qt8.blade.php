            ...
            <div class="row mt-1 d-flex justify-content-center">
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="lifestyle_peaceful">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://st2.depositphotos.com/1715570/7477/i/450/depositphotos_74774975-stock-photo-african-american-woman-meditating-in.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="lifestyle_career">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://community.thriveglobal.com/wp-content/uploads/2020/09/Stay-Focused-on-Career-goals.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="lifestyle_active">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://snacknation.com/wp-content/uploads/2019/07/Basketball.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="lifestyle_chill">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://www.shutterstock.com/image-photo/relaxed-teen-girl-wearing-earphones-600nw-2240895751.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="lifestyle_travel">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://community.thriveglobal.com/wp-content/uploads/2019/03/Travel-and-health.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="lifestyle_healthy">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://www.eatthis.com/wp-content/uploads/sites/4/2022/08/happy-mature-woman-jump-rope-sunset-e1661314460955.jpg?quality=82&strip=1">
                        </div>
                        <div class="box-text">
