  ...
  <div class="qt-carnow">
      <div class="row ">
          <div class="col-12 mt-5">
              <h5 class="text-center answertitle">ปัจจุบันคุณใช้งานรถประเภทใดอยู่ 9/18</h5>
          </div>
      </div>
      ...
      <div class="row mt-1 d-flex justify-content-center">
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_coupe">
                  ...
                  <div class="box-img text-center mt-2">
                      <img src="https://autolifethailand.tv/wp-content/uploads/2023/07/23c0191_003.jpg">
                  </div>
                  <div class="box-text">
          ...
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_convertible">
                  ...
                  <div class="box-img text-center mt-2">
                      <img
                          src="https://upload.wikimedia.org/wikipedia/commons/6/67/20th_Anniversary_TransAm_Convertible_One_of_2.png">
                  </div>
                  <div class="box-text">
          ...
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_sedan">
                  <i class="bi bi-check px-1 mt-1"></i>
                  <div class="box-img text-center mt-2">
                      <img src="https://file.chobrod.com/2019/02/12/LnbzF9To/image02-18-e716.jpg">
                  </div>
                  <div class="box-text">
          ...
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_pickup">
                  ...
                  <div class="box-img text-center mt-2">
                      <img
                          src="https://www.topgear.com/sites/default/files/2021/06/Hennessey%20Mammoth%201000%20TRX_001.jpg">
                  </div>
                  <div class="box-text">
          ...
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_hatchback">
                  <i class="bi bi-check px-1 mt-1"></i>
                  <div class="box-img text-center mt-2">
                      <img src="https://s.isanook.com/au/0/ud/15/77988/2021hondacityhatchback1.jpg">
                  </div>
                  <div class="box-text">
          ...
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_wagon">
                  <i class="bi bi-check px-1 mt-1"></i>
                  <div class="box-img text-center mt-2">
                      <img src="https://www.car250.com/wp-content/uploads/2022/07/Volvo_850Recharge_2-copy.webp">
                  </div>
                  <div class="box-text">
                      <h6 class="text-center">Station Wagon</h6>
                  </div>
              </label>
          </div>
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_suv">
                  <i class="bi bi-check px-1 mt-1"></i>
                  <div class="box-img text-center mt-2">
                      <img src="https://www.carsome.co.th/news/wp-content/uploads/Toyota-bZ4X-1024x556.jpg">
                  </div>
                  <div class="box-text">
          ...
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_minivan">
                  <i class="bi bi-check px-1 mt-1"></i>
                  <div class="box-img text-center mt-2">
                      <img src="https://file.chobrod.com/2018/07/24/nkNHHn8K/minivan1-5919.jpg">
                  </div>
                  <div class="box-text">
          ...
          <div class="col-6 col-lg-2 my-1">
              ...
              <label class="box-lable" for="carnow_no">
                  <i class="bi bi-check px-1 mt-1"></i>
                  <div class="box-img text-center mt-2">
                      <img src="https://img5.pic.in.th/file/secure-sv1/nocar-1.png">
                  </div>
                  <div class="box-text">
