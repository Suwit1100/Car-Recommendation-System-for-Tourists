     ...
     <div class="row mt-1 d-flex justify-content-center">
         ...
         <div class="col-6 col-lg-2 my-1">
             ...
             <label class="box-lable" for="junior_high_school">
                 <i class="bi bi-check px-1 mt-1"></i>
                 <div class="box-img text-center mt-2">
                     <img src="https://aksornpattaya.aksorn.ac.th/wp-content/uploads/2019/04/IMG_2666-1024x683.jpg">
                 </div>
                 <div class="box-text">
         ...
         <div class="col-6 col-lg-2 my-1">
             ...
             <label class="box-lable" for="associate_degree">
                 <i class="bi bi-check px-1 mt-1"></i>
                 <div class="box-img text-center mt-2">
                     <img src="https://c1.staticflickr.com/5/4536/37570260314_4af9785b2d_z.jpg">
                 </div>
                 <div class="box-text">
         ...
         <div class="col-6 col-lg-2 my-1">
             ...
             <label class="box-lable" for="master_degree">
                 <i class="bi bi-check px-1 mt-1"></i>
                 <div class="box-img text-center mt-2">
                     <img src="https://storage-wp.thaipost.net/2022/01/93.jpg">
                 </div>
                 <div class="box-text">
