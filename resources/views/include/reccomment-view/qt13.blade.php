            ...
            <div class="row mt-1 d-flex justify-content-center">
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="factordrive_comfortseat">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://lh4.googleusercontent.com/Nz3Lgrp9DW6ma0PNCDnp6w3KlipFzG7Ofh6ZAFIZTEAU0VqCsXuojY_z05I7s8ZXe1zPcmNUs0Oq9or7cvCyCtfyuAnyi4l9tGiWmFFYeE3RDjRh3FxdGk2MrWjYX-TTODbkit-zYoGUf5NPFw">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="factordrive_carstorage">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://image.bestreview.asia/wp-content/uploads/2020/07/Car-trunk-2.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="factordrive_connecting">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://www.elecpress.com/wp-content/uploads/2019/04/tesla-full-self-driving-demo-Robotaxi.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="factordrive_safety">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://img.icarcdn.com/autospinn/body/547566_eueeeNoDK09ijEBmo4wGic.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="factordrive_fueleconomy">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://s.isanook.com/au/0/ud/16/81631/fuel_02.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    <input type="radio" class="btn-check" name="factordrive" id="factordrive_speed" autocomplete="off"
                        value="speed">
                    <label class="box-lable" for="factordrive_speed">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://www.hugsinsurance.com/storage/images/article/oysRSQ9boK5jOFCOBffh8M47plBEPDMp.jpeg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="factordrive_design">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://3.bp.blogspot.com/-YyX9Dh92OfI/UhmzZo0bktI/AAAAAAAAApM/BhIDv1wevVs/s1600/kapook_world-400980.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="factordrive_lifestyle">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://static.thairath.co.th/media/B6FtNKtgSqRqbnNsbEeHRNdddCkLuOhmbt4ZcFthsv0K1yr45lO6EakgfKQ2T5YTlWotw.webp">
                        </div>
                        <div class="box-text">
