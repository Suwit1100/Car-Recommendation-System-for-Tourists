            ...
            <div class="row mt-1 d-flex justify-content-center">
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="student">
                        ...
                        <div class="box-img text-center mt-2">
                            <img src="https://mpics.mgronline.com/pics/Images/566000006919702.JPEG">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="company_employee">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://eventbanana.blob.core.windows.net/blogcontainer/88eca2b-803f.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="personal_business">
                        ...
                        <div class="box-img text-center mt-2">
                            <img
                                src="https://blog.cariber.co/wp-content/uploads/2022/09/thinking-asian-businessman-businessman-talking-phone-working-modern-office-listening-seriously.jpg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="it">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://www.ppmcontract.com/wp-content/uploads/2023/03/108306672-scaled.jpeg">
                        </div>
                        <div class="box-text">
                ...
                <div class="col-6 col-lg-2 my-1">
                    ...
                    <label class="box-lable" for="freelance">
                        <i class="bi bi-check px-1 mt-1"></i>
                        <div class="box-img text-center mt-2">
                            <img src="https://www.urhr.info/wp-content/uploads/2021/05/Freelance-2.jpg">
                        </div>
                        <div class="box-text">
