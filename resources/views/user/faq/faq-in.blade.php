...
@section('content')
    <div class="row">
        <div class="col-12 text-end mt-3">
            <a class="text-dark" href="{{ route('faq_view') }}">
                <i class="fa-solid fa-circle-left i-back"></i>
            </a>
        </div>
    </div>
    @include('include.faq-in.box-first')
    @include('include.faq-in.box-reply')
    @include('include.faq-in.box-reply-content')
@endsection
@section('script')
    <script>
        // คลิก upimg
