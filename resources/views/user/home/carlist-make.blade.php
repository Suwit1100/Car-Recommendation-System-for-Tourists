...
@section('content')
    ...
    <div class="row">
        {{-- ตัวกรอง st --}}
        @include('include.carlist-make.filter')
        {{-- ตัวกรอง ed --}}
        <div class="col-12 col-md-8">
            @include('include.carlist-make.header')
            @include('include.carlist-make.valselect')
            {{-- carlist-make --}}
            <div class="row" id="cardata">
                @include('include.carlist-make.datacar')
            </div>
        ...
        @include('include.carlist-make.filtermobile')
    </div>
