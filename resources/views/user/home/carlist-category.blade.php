...
@section('content')
    ...
    <div class="row">
        {{-- ตัวกรอง st --}}
        @include('include.carlist-category.filter')
        {{-- ตัวกรอง ed --}}
        <div class="col-12 col-md-8">
            @include('include.carlist-category.header')
            @include('include.carlist-category.valselect')
            {{-- carlist-category --}}
            <div class="row" id="cardata">
                @include('include.carlist-category.datacar')
            </div>
        ...
        @include('include.carlist-category.filtermobile')
    </div>
